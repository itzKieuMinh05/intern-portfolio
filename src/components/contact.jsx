...
const socialLinks = [
  {
    href: 'https://github.com/itzKieuMinh05',
  ...
  {
    href: 'https://www.linkedin.com/in/ki%E1%BB%81u-t%E1%BA%A5n-anh-minh-a616b027a/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{
  href: 'https://www.facebook.com/MinhKieu1501/',
  icon: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M22 12C22 6.477 17.523 2 12 2C6.477 2 2 6.477 2 12C2 16.991 5.656 21.128 10.438 21.878V14.89H7.898V12H10.438V9.797C10.438 7.29 11.93 5.907 14.214 5.907C15.309 5.907 16.453 6.103 16.453 6.103V8.563H15.193C13.951 8.563 13.562 9.324 13.562 10.109V12H16.328L15.875 14.89H13.562V21.878C18.344 21.128 22 16.991 22 12Z" fill="currentColor"/>
    </svg>
  ),
  alt: 'Facebook'
},
  {
    href: 'https://www.instagram.com/mikieu1501/',
    ...
    return (
        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <form 
                action="https://getform.io/f/bqoekqwb" 
                method="POST"
                className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="mb-4">
                        ...
                        <textarea 
                            ...
                            placeholder="hi!" 
                            required
                            className="text-field resize-y min-h-32 max-h-60">
                        </textarea>
                    </div>
